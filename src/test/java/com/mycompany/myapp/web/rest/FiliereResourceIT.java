...
class FiliereResourceIT {
    ...
    private static final NomFiliere DEFAULT_NOM_FILIERE = NomFiliere.AGRI_ELEVAGE;
    private static final NomFiliere UPDATED_NOM_FILIERE = NomFiliere.AGRICULTURE;
    ...
    private static final String DEFAULT_AUTRE_NIVEAU_ETUDE = "AAAAAAAAAA";
    private static final String UPDATED_AUTRE_NIVEAU_ETUDE = "BBBBBBBBBB";
    ...
    public static Filiere createEntity(EntityManager em) {
        Filiere filiere = new Filiere()
            ...
            .autreNiveauEtude(DEFAULT_AUTRE_NIVEAU_ETUDE)
    ...
    public static Filiere createUpdatedEntity(EntityManager em) {
        Filiere filiere = new Filiere()
            ...
            .autreNiveauEtude(UPDATED_AUTRE_NIVEAU_ETUDE)
    ...
    void createFiliere() throws Exception {
        ...
        assertThat(testFiliere.getNiveauEtude()).isEqualTo(DEFAULT_NIVEAU_ETUDE);
        assertThat(testFiliere.getProgramme()).isEqualTo(DEFAULT_PROGRAMME);
        assertThat(testFiliere.getAutreNiveauEtude()).isEqualTo(DEFAULT_AUTRE_NIVEAU_ETUDE);
    ...
    void getAllFilieres() throws Exception {
        ...
        restFiliereMockMvc
            ...
            .andExpect(jsonPath("$.[*].autreNiveauEtude").value(hasItem(DEFAULT_AUTRE_NIVEAU_ETUDE)))
    ...
    void getFiliere() throws Exception {
        ...
        restFiliereMockMvc
            ...
            .andExpect(jsonPath("$.autreNiveauEtude").value(DEFAULT_AUTRE_NIVEAU_ETUDE))
    ...
    void putNewFiliere() throws Exception {
        ...
        assertThat(testFiliere.getNiveauEtude()).isEqualTo(UPDATED_NIVEAU_ETUDE);
        assertThat(testFiliere.getProgramme()).isEqualTo(UPDATED_PROGRAMME);
        assertThat(testFiliere.getAutreNiveauEtude()).isEqualTo(UPDATED_AUTRE_NIVEAU_ETUDE);
    ...
    void putWithMissingIdPathParamFiliere() throws Exception {
        ...
        restFiliereMockMvc
            .perform(
                put(ENTITY_API_URL).with(csrf()).contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(filiere))
            )
    ...
    void partialUpdateFiliereWithPatch() throws Exception {
        ...
        partialUpdatedFiliere.nomFiliere(UPDATED_NOM_FILIERE).niveauEtude(UPDATED_NIVEAU_ETUDE).autreFiliere(UPDATED_AUTRE_FILIERE);
