...
public interface EtablissementRepository extends JpaRepository<Etablissement, Long> {
    ...
    @Query(
        value = "select distinct etablissement from Etablissement etablissement left join fetch etablissement.localite",
    ...
    @Query("select distinct etablissement from Etablissement etablissement left join fetch etablissement.localite")
    List<Etablissement> findAllWithToOneRelationships();

    @Query("select etablissement from Etablissement etablissement left join fetch etablissement.localite where etablissement.id =:id")
