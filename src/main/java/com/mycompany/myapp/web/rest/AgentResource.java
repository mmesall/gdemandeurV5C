...
public class AgentResource {
    ...
    public ResponseEntity<Agent> updateAgent(@PathVariable(value = "id", required = false) final Long id, @RequestBody Agent agent)
    ...
    public ResponseEntity<Agent> partialUpdateAgent(@PathVariable(value = "id", required = false) final Long id, @RequestBody Agent agent)
        throws URISyntaxException {
    ...
    public ResponseEntity<List<Agent>> getAllAgents(
        ...
        if ("bailleur-is-null".equals(filter)) {
            log.debug("REST request to get all Agents where bailleur is null");
            return new ResponseEntity<>(agentService.findAllWhereBailleurIsNull(), HttpStatus.OK);
        }

        if ("membre-is-null".equals(filter)) {
            log.debug("REST request to get all Agents where membre is null");
            return new ResponseEntity<>(agentService.findAllWhereMembreIsNull(), HttpStatus.OK);
        }
