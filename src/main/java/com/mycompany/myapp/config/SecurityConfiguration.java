...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    public void configure(HttpSecurity http) throws Exception {
        ...
        .and()
            ...
            .antMatchers("/management/**").hasAuthority(AuthoritiesConstants.AGENT)
            .antMatchers("/management/**").hasAuthority(AuthoritiesConstants.DEMANDEUR)
            .antMatchers("/management/**").hasAuthority(AuthoritiesConstants.DRH)
            .antMatchers("/management/**").hasAuthority(AuthoritiesConstants.DECPC)
            .antMatchers("/management/**").hasAuthority(AuthoritiesConstants.BAILLEUR)
        .and()
            .oauth2Login()
        .and()
