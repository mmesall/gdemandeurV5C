...
describe('Demandeur Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'demandeur', component: DemandeurComponent }]), HttpClientTestingModule],
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.demandeurs?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
