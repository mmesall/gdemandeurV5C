...
describe('Concours Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'concours', component: ConcoursComponent }]), HttpClientTestingModule],
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.concours?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
