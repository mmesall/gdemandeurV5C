...
describe('Commission Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'commission', component: CommissionComponent }]), HttpClientTestingModule],
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.commissions?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
