...
describe('Bailleur Management Component', () => {
  let comp: BailleurComponent;
  let fixture: ComponentFixture<BailleurComponent>;
  let service: BailleurService;

  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'bailleur', component: BailleurComponent }]), HttpClientTestingModule],
      ...
      .overrideTemplate(BailleurComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.bailleurs?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
