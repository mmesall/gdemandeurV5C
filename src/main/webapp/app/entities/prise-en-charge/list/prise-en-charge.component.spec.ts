...
describe('PriseEnCharge Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'prise-en-charge', component: PriseEnChargeComponent }]), HttpClientTestingModule],
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.priseEnCharges?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
