...
describe('SessionForm Management Component', () => {
  let comp: SessionFormComponent;
  let fixture: ComponentFixture<SessionFormComponent>;
  let service: SessionFormService;

  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'session-form', component: SessionFormComponent }]), HttpClientTestingModule],
      ...
      .overrideTemplate(SessionFormComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.sessionForms?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
