...
describe('Professionnel routing resolve service', () => {
  ...
  let routingResolveService: ProfessionnelRoutingResolveService;
  let service: ProfessionnelService;
  let resultProfessionnel: IProfessionnel | undefined;
  ...
  beforeEach(() => {
    ...
    routingResolveService = TestBed.inject(ProfessionnelRoutingResolveService);
  ...
  describe('resolve', () => {
    ...
    it('should return new IProfessionnel if id is not provided', () => {
      // GIVEN
      ...
      expect(resultProfessionnel).toEqual(new Professionnel());
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse({ body: null as unknown as Professionnel })));
      mockActivatedRouteSnapshot.params = { id: 123 };
