...
describe('Professionnel Management Component', () => {
  let comp: ProfessionnelComponent;
  let fixture: ComponentFixture<ProfessionnelComponent>;
  let service: ProfessionnelService;

  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'professionnel', component: ProfessionnelComponent }]), HttpClientTestingModule],
      ...
      .overrideTemplate(ProfessionnelComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.professionnels?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
